package com.example.mcfal.moduleninebikeandbarge;
...
import com.example.mcfal.moduleninebikeandbarge.dummy.DummyContent;
...
//            ((WebView)rootView.findViewById(R.id.item_detail)).loadUrl(mItem.item_url);
            WebView myWebView = (WebView) rootView.findViewById(R.id.item_detail);
